...
from cooking_seasonally.helpers.utils import get_recipes, BASE_DIR
  
def get_main_ingerdients_per_recipe(model: spacy.language.Doc, recipe: Recipe) -> List[str]:
...
if __name__ == '__main__':
    ...
    processed_json_path = Path(BASE_DIR) / "data/processed/ottolenghi_processed_recipes.json"
